...
with open("latex/includes/pressure_vessel_problem_original_wilcoxon_test.tex", "r") as f:
    content += f.read() + "\n"

with open("latex/includes/pressure_vessel_problem_wilcoxon_test.tex", "r") as f:
    content += f.read() + "\n"

with open("latex/includes/spring_problem_wilcoxon_test.tex", "r") as f:
    content += f.read() + "\n"
